...
public class NFCActivity extends AppCompatActivity {
    ...
    private NFCStartFragment nfcStartFragment;
    private NFCActivityFragment nfcActivityFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.fragment_container) != null) {
            ...
            // Create a new Fragment to be placed in the activity layout
            nfcStartFragment = new NFCStartFragment();

            // In case this activity was started with special instructions from an
            // Intent, pass the Intent's extras to the fragment as arguments
            nfcStartFragment.setArguments(getIntent().getExtras());

            // Add the fragment to the 'fragment_container' FrameLayout
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.fragment_container, nfcStartFragment).addToBackStack(null).commit();
        }
        ...
        if (mNfcAdapter.isEnabled()) {
            // Stop here, we definitely need NFC
            Toast.makeText(this, "NFC adapter activated", Toast.LENGTH_LONG).show();
        }
    ...
    private class NdefReaderTask extends AsyncTask<Tag, Void, String> {
        ...
        protected String doInBackground(Tag... params) {
            ...
            if (ndefMessage == null){
                nfcActivityFragment = new NFCActivityFragment();
//                Intent intent = new Intent();
//                intent.putExtra()
//                nfcActivityFragment.setArguments();
                // Add the fragment to the 'fragment_container' FrameLayout
                FragmentTransaction transaction =getSupportFragmentManager().beginTransaction().addToBackStack(null)
                        .replace(nfcStartFragment.getId(),nfcActivityFragment,"NFC_ACTIVITIES");
//                transaction.
                transaction.commit();
